    ...
    render() {
        ...
        return (
            <SoundEditorComponent
                ...
                onSonicDestructor={this.effectFactory(effectTypes.SONIC_DESTRUCTOR)}
                onBrokenMic={this.effectFactory(effectTypes.BROKEN_MIC)}
                onDemonized={this.effectFactory(effectTypes.DEMONIZED)}
                onLostSoul={this.effectFactory(effectTypes.LOST_SOUL)}
                onDivineEcho={this.effectFactory(effectTypes.DIVINE_ECHO)}
                onSplitEchoes={this.effectFactory(effectTypes.SPLIT_ECHOES)}
                onEthereal={this.effectFactory(effectTypes.ETHEREAL)}
                onBandpassReverb={this.effectFactory(effectTypes.BANDPASS_REVERB)}
                onRadiantEcho={this.effectFactory(effectTypes.RADIANT_ECHO)}
                onFlashback={this.effectFactory(effectTypes.FLASHBACK)}
                onEcho={this.effectFactory(effectTypes.ECHO)}
                onInfiniteEchoes={this.effectFactory(effectTypes.INFINITE_ECHOES)}
                onMemories={this.effectFactory(effectTypes.MEMORIES)}
                onEtherealIi={this.effectFactory(effectTypes.ETHEREAL_II)}
                onEchoPlus={this.effectFactory(effectTypes.ECHO_PLUS)}
                onSoulJourney={this.effectFactory(effectTypes.SOUL_JOURNEY)}
                onCrispMic={this.effectFactory(effectTypes.CRISP_MIC)}
                onSoundWidener={this.effectFactory(effectTypes.SOUND_WIDENER)}
                onPsychedelic={this.effectFactory(effectTypes.PSYCHEDELIC)}
                ...
                onAnalogEcho={this.effectFactory(effectTypes.ANALOG_ECHO)}
                onStadiumAnnouncer={this.effectFactory(effectTypes.STADIUM_ANNOUNCER)}
                onEcko={this.effectFactory(effectTypes.ECKO)}
                onLoudBreaths={this.effectFactory(effectTypes.LOUD_BREATHS)}
                onHarmony={this.effectFactory(effectTypes.HARMONY)}
                onPanoramic={this.effectFactory(effectTypes.PANORAMIC)}
                onTalkToTheHand={this.effectFactory(effectTypes.TALK_TO_THE_HAND)}
                onConsoleHeadset={this.effectFactory(effectTypes.CONSOLE_HEADSET)}
                onConcert={this.effectFactory(effectTypes.CONCERT)}
                onReverb={this.effectFactory(effectTypes.REVERB)}
                onInTheWind={this.effectFactory(effectTypes.IN_THE_WIND)}
                onRoboto={this.effectFactory(effectTypes.ROBOTO)}
                onToyMicrophone={this.effectFactory(effectTypes.TOY_MICROPHONE)}
                onCubicleEcho={this.effectFactory(effectTypes.CUBICLE_ECHO)}
                onPipa={this.effectFactory(effectTypes.PIPA)}
                onChorus={this.effectFactory(effectTypes.CHORUS)}
                onInWomb={this.effectFactory(effectTypes.IN_WOMB)}
                onTheVoice={this.effectFactory(effectTypes.THE_VOICE)}
                onPhoneConvo={this.effectFactory(effectTypes.PHONE_CONVO)}
                onPracticeRoom={this.effectFactory(effectTypes.PRACTICE_ROOM)}
                onMeditation={this.effectFactory(effectTypes.MEDITATION)}
                onDivina={this.effectFactory(effectTypes.DIVINA)}
                onBooming={this.effectFactory(effectTypes.BOOMING)}
                onEmptyStudio={this.effectFactory(effectTypes.EMPTY_STUDIO)}
                onSurroundBlast={this.effectFactory(effectTypes.SURROUND_BLAST)}
                onRetroVibe={this.effectFactory(effectTypes.RETRO_VIBE)}
                onGuitarDelay={this.effectFactory(effectTypes.GUITAR_DELAY)}
                onEchoey={this.effectFactory(effectTypes.ECHOEY)}
                onMagnetic={this.effectFactory(effectTypes.MAGNETIC)}
                onVintagePhone={this.effectFactory(effectTypes.VINTAGE_PHONE)}
                onMutedBeat={this.effectFactory(effectTypes.MUTED_BEAT)}
                onConcertHall={this.effectFactory(effectTypes.CONCERT_HALL)}
                onDripVocals={this.effectFactory(effectTypes.DRIP_VOCALS)}
                onDrift={this.effectFactory(effectTypes.DRIFT)}
                onDrownedOut={this.effectFactory(effectTypes.DROWNED_OUT)}
                onHuskyBackup={this.effectFactory(effectTypes.HUSKY_BACKUP)}
                onPayphone={this.effectFactory(effectTypes.PAYPHONE)}
                onDeafness={this.effectFactory(effectTypes.DEAFNESS)}
                onInTheRain={this.effectFactory(effectTypes.IN_THE_RAIN)}
                onStreetAnthem={this.effectFactory(effectTypes.STREET_ANTHEM)}
                onOffice={this.effectFactory(effectTypes.OFFICE)}
                onBackpackRadio={this.effectFactory(effectTypes.BACKPACK_RADIO)}
                onHell={this.effectFactory(effectTypes.HELL)}
                onEchoIi={this.effectFactory(effectTypes.ECHO_II)}
                onDoomsdayPa={this.effectFactory(effectTypes.DOOMSDAY_PA)}
                onParkingLot={this.effectFactory(effectTypes.PARKING_LOT)}
                onOuterDimension={this.effectFactory(effectTypes.OUTER_DIMENSION)}
                onDistortion={this.effectFactory(effectTypes.DISTORTION)}
                onCave={this.effectFactory(effectTypes.CAVE)}
                onRapAttitude={this.effectFactory(effectTypes.RAP_ATTITUDE)}
                onClaps={this.effectFactory(effectTypes.CLAPS)}
                onPaAnnouncer={this.effectFactory(effectTypes.PA_ANNOUNCER)}
                onMusicHall={this.effectFactory(effectTypes.MUSIC_HALL)}
                onTubeTv={this.effectFactory(effectTypes.TUBE_TV)}
                onLoudspeaker={this.effectFactory(effectTypes.LOUDSPEAKER)}
                onEightBit={this.effectFactory(effectTypes.EIGHT_BIT)}
                onGrumpyOrc={this.effectFactory(effectTypes.GRUMPY_ORC)}
                onPhantomEcho={this.effectFactory(effectTypes.PHANTOM_ECHO)}
                onMusicEnhancer={this.effectFactory(effectTypes.MUSIC_ENHANCER)}
                onHeartbeats={this.effectFactory(effectTypes.HEARTBEATS)}
                onCassetteTape={this.effectFactory(effectTypes.CASSETTE_TAPE)}
                onBadHarmony={this.effectFactory(effectTypes.BAD_HARMONY)}
                onBigHouse={this.effectFactory(effectTypes.BIG_HOUSE)}
                onNightClub={this.effectFactory(effectTypes.NIGHT_CLUB)}
                onElectronicBeats={this.effectFactory(effectTypes.ELECTRONIC_BEATS)}
                onAlienRadio={this.effectFactory(effectTypes.ALIEN_RADIO)}
                onLiveBroadcast={this.effectFactory(effectTypes.LIVE_BROADCAST)}
                onPsyelectro={this.effectFactory(effectTypes.PSYELECTRO)}
                onAirLight={this.effectFactory(effectTypes.AIR_LIGHT)}
                onVinyl={this.effectFactory(effectTypes.VINYL)}
                onWave={this.effectFactory(effectTypes.WAVE)}
                onOutOfSignal={this.effectFactory(effectTypes.OUT_OF_SIGNAL)}
                onAutotune={this.effectFactory(effectTypes.AUTOTUNE)}
                onBirthdayParty={this.effectFactory(effectTypes.BIRTHDAY_PARTY)}
                onDroneSpeaker={this.effectFactory(effectTypes.DRONE_SPEAKER)}
                onGravellyAlien={this.effectFactory(effectTypes.GRAVELLY_ALIEN)}
                onDjWarp={this.effectFactory(effectTypes.DJ_WARP)}
                onBahh={this.effectFactory(effectTypes.BAHH)}
                onEvilSpirit={this.effectFactory(effectTypes.EVIL_SPIRIT)}
                onBadMic={this.effectFactory(effectTypes.BAD_MIC)}
                onValley={this.effectFactory(effectTypes.VALLEY)}
                onIceCave={this.effectFactory(effectTypes.ICE_CAVE)}
                onBroadwayOne={this.effectFactory(effectTypes.BROADWAY_ONE)}
                onGhostStory={this.effectFactory(effectTypes.GHOST_STORY)}
                onOldPhone={this.effectFactory(effectTypes.OLD_PHONE)}
                onEnergetic={this.effectFactory(effectTypes.ENERGETIC)}
                onLosingSanity={this.effectFactory(effectTypes.LOSING_SANITY)}
                onBroadwayTwo={this.effectFactory(effectTypes.BROADWAY_TWO)}
                onBWTv={this.effectFactory(effectTypes.BANDW_TV)}
                onSuperBass={this.effectFactory(effectTypes.SUPER_BASS)}
                onSpaceIntercom={this.effectFactory(effectTypes.SPACE_INTERCOM)}
                onElectronic={this.effectFactory(effectTypes.ELECTRONIC)}
                onThreedSurroundSound={this.effectFactory(effectTypes.THREED_SURROUND_SOUND)}
                onClassroom={this.effectFactory(effectTypes.CLASSROOM)}
                onCommuting={this.effectFactory(effectTypes.COMMUTING)}
                onSuperReverb={this.effectFactory(effectTypes.SUPER_REVERB)}
                onTremble={this.effectFactory(effectTypes.TREMBLE)}
                onBleepCensor={this.effectFactory(effectTypes.BLEEP_CENSOR)}
                onIntercom={this.effectFactory(effectTypes.INTERCOM)}
                onTelephone={this.effectFactory(effectTypes.TELEPHONE)}
                onLiveHouse={this.effectFactory(effectTypes.LIVE_HOUSE)}
                onRoom={this.effectFactory(effectTypes.ROOM)}
                onGuardMask={this.effectFactory(effectTypes.GUARD_MASK)}
                onSoundSharpener={this.effectFactory(effectTypes.SOUND_SHARPENER)}
                onInterference={this.effectFactory(effectTypes.INTERFERENCE)}
                onVintageFilm={this.effectFactory(effectTypes.VINTAGE_FILM)}
                onHamsters={this.effectFactory(effectTypes.HAMSTERS)}
                onDesert={this.effectFactory(effectTypes.DESERT)}
                onAlienDistorter={this.effectFactory(effectTypes.ALIEN_DISTORTER)}
                onSkipping={this.effectFactory(effectTypes.SKIPPING)}
                onViaSpeaker={this.effectFactory(effectTypes.VIA_SPEAKER)}
                onAircraftBroadcast={this.effectFactory(effectTypes.AIRCRAFT_BROADCAST)}
                onBotilda={this.effectFactory(effectTypes.BOTILDA)}
                onMeowSpeaker={this.effectFactory(effectTypes.MEOW_SPEAKER)}
                onGlitchy={this.effectFactory(effectTypes.GLITCHY)}
                onVocoda={this.effectFactory(effectTypes.VOCODA)}
                onSchoolPa={this.effectFactory(effectTypes.SCHOOL_PA)}
                onToyMic={this.effectFactory(effectTypes.TOY_MIC)}
                onFullStack={this.effectFactory(effectTypes.FULL_STACK)}
                onFluteConverter={this.effectFactory(effectTypes.FLUTE_CONVERTER)}
                onMicMalfunction={this.effectFactory(effectTypes.MIC_MALFUNCTION)}
                onElectro={this.effectFactory(effectTypes.ELECTRO)}
                onCheapPhone={this.effectFactory(effectTypes.CHEAP_PHONE)}
                onMuffler={this.effectFactory(effectTypes.MUFFLER)}
                onIndoorVoice={this.effectFactory(effectTypes.INDOOR_VOICE)}
                onDistortedMic={this.effectFactory(effectTypes.DISTORTED_MIC)}
                onCatTranslator={this.effectFactory(effectTypes.CAT_TRANSLATOR)}
                onMetallicHell={this.effectFactory(effectTypes.METALLIC_HELL)}
                onBoxedIn={this.effectFactory(effectTypes.BOXED_IN)}
                onElectroShift={this.effectFactory(effectTypes.ELECTRO_SHIFT)}
                onBathroom={this.effectFactory(effectTypes.BATHROOM)}
                onVinnie={this.effectFactory(effectTypes.VINNIE)}
                onMilitaryRadio={this.effectFactory(effectTypes.MILITARY_RADIO)}
                onLiveStage={this.effectFactory(effectTypes.LIVE_STAGE)}
                onBawkTalk={this.effectFactory(effectTypes.BAWK_TALK)}
                onUnderwater={this.effectFactory(effectTypes.UNDERWATER)}
                onChurch={this.effectFactory(effectTypes.CHURCH)}
                onTweeting={this.effectFactory(effectTypes.TWEETING)}
                onMetalPipes={this.effectFactory(effectTypes.METAL_PIPES)}
                onTickingClock={this.effectFactory(effectTypes.TICKING_CLOCK)}
                onClassicFmRadio={this.effectFactory(effectTypes.CLASSIC_FM_RADIO)}
                onPhoneCall={this.effectFactory(effectTypes.PHONE_CALL)}
                onTimeMachine={this.effectFactory(effectTypes.TIME_MACHINE)}
                onAlienDistortion={this.effectFactory(effectTypes.ALIEN_DISTORTION)}
                onSynth={this.effectFactory(effectTypes.SYNTH)}
                onSpaceAnnouncer={this.effectFactory(effectTypes.SPACE_ANNOUNCER)}
                onOldVhsTape={this.effectFactory(effectTypes.OLD_VHS_TAPE)}
                onArchibald={this.effectFactory(effectTypes.ARCHIBALD)}
                onFan={this.effectFactory(effectTypes.FAN)}
                onAccordroid={this.effectFactory(effectTypes.ACCORDROID)}
                onBadSignal={this.effectFactory(effectTypes.BAD_SIGNAL)}
                onRiderHelmet={this.effectFactory(effectTypes.RIDER_HELMET)}
                onTeenager={this.effectFactory(effectTypes.TEENAGER)}
                onOldTelephone={this.effectFactory(effectTypes.OLD_TELEPHONE)}
                onDistortedElectron={this.effectFactory(effectTypes.DISTORTED_ELECTRON)}
                onOnThePhone={this.effectFactory(effectTypes.ON_THE_PHONE)}
                onPhantomFace={this.effectFactory(effectTypes.PHANTOM_FACE)}
                onEmergency={this.effectFactory(effectTypes.EMERGENCY)}
                onKiddo={this.effectFactory(effectTypes.KIDDO)}
                onOldHollywood={this.effectFactory(effectTypes.OLD_HOLLYWOOD)}
