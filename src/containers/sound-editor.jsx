    ...
    render() {
        ...
        return (
            <SoundEditorComponent
                ...
                onDroneSpeaker={this.effectFactory(effectTypes.DRONESPEAKER)}
                onTubeTV={this.effectFactory(effectTypes.TUBETV)}
                onAbkhaz={this.effectFactory(effectTypes.ABKHAZ)}
onAcehnese={this.effectFactory(effectTypes.ACEHNESE)}
onAcholi={this.effectFactory(effectTypes.ACHOLI)}
onAfar={this.effectFactory(effectTypes.AFAR)}
onAfrikaans={this.effectFactory(effectTypes.AFRIKAANS)}
onAlbanian={this.effectFactory(effectTypes.ALBANIAN)}
onAlur={this.effectFactory(effectTypes.ALUR)}
onAmharic={this.effectFactory(effectTypes.AMHARIC)}
onArabic={this.effectFactory(effectTypes.ARABIC)}
onArmenian={this.effectFactory(effectTypes.ARMENIAN)}
onAssamese={this.effectFactory(effectTypes.ASSAMESE)}
onAvar={this.effectFactory(effectTypes.AVAR)}
onAwadhi={this.effectFactory(effectTypes.AWADHI)}
onAymara={this.effectFactory(effectTypes.AYMARA)}
onAzerbaijani={this.effectFactory(effectTypes.AZERBAIJANI)}
onBalinese={this.effectFactory(effectTypes.BALINESE)}
onBaluchi={this.effectFactory(effectTypes.BALUCHI)}
onBambara={this.effectFactory(effectTypes.BAMBARA)}
onBaoule={this.effectFactory(effectTypes.BAOULE)}
onBashkir={this.effectFactory(effectTypes.BASHKIR)}
onBasque={this.effectFactory(effectTypes.BASQUE)}
onBatakKaro={this.effectFactory(effectTypes.BATAKKARO)}
onBatakSimalungun={this.effectFactory(effectTypes.BATAKSIMALUNGUN)}
onBatakToba={this.effectFactory(effectTypes.BATAKTOBA)}
onBelarusian={this.effectFactory(effectTypes.BELARUSIAN)}
onBemba={this.effectFactory(effectTypes.BEMBA)}
onBengali={this.effectFactory(effectTypes.BENGALI)}
onBetawi={this.effectFactory(effectTypes.BETAWI)}
onBhojpuri={this.effectFactory(effectTypes.BHOJPURI)}
onBikol={this.effectFactory(effectTypes.BIKOL)}
onBosnian={this.effectFactory(effectTypes.BOSNIAN)}
onBreton={this.effectFactory(effectTypes.BRETON)}
onBulgarian={this.effectFactory(effectTypes.BULGARIAN)}
onBuryat={this.effectFactory(effectTypes.BURYAT)}
onCantonese={this.effectFactory(effectTypes.CANTONESE)}
onCatalan={this.effectFactory(effectTypes.CATALAN)}
onCebuano={this.effectFactory(effectTypes.CEBUANO)}
onChamorro={this.effectFactory(effectTypes.CHAMORRO)}
onChechen={this.effectFactory(effectTypes.CHECHEN)}
onChichewa={this.effectFactory(effectTypes.CHICHEWA)}
onChineseSimplified={this.effectFactory(effectTypes.CHINESESIMPLIFIED)}
onChineseTraditional={this.effectFactory(effectTypes.CHINESETRADITIONAL)}
onChuukese={this.effectFactory(effectTypes.CHUUKESE)}
onChuvash={this.effectFactory(effectTypes.CHUVASH)}
onCorsican={this.effectFactory(effectTypes.CORSICAN)}
onCrimeanTatarCyrillic={this.effectFactory(effectTypes.CRIMEANTATARCYRILLIC)}
onCrimeanTatarLatin={this.effectFactory(effectTypes.CRIMEANTATARLATIN)}
onCroatian={this.effectFactory(effectTypes.CROATIAN)}
onCzech={this.effectFactory(effectTypes.CZECH)}
onDanish={this.effectFactory(effectTypes.DANISH)}
onDari={this.effectFactory(effectTypes.DARI)}
onDhivehi={this.effectFactory(effectTypes.DHIVEHI)}
onDinka={this.effectFactory(effectTypes.DINKA)}
onDogri={this.effectFactory(effectTypes.DOGRI)}
onDombe={this.effectFactory(effectTypes.DOMBE)}
onDutch={this.effectFactory(effectTypes.DUTCH)}
onDyula={this.effectFactory(effectTypes.DYULA)}
onDzongkha={this.effectFactory(effectTypes.DZONGKHA)}
onEnglish={this.effectFactory(effectTypes.ENGLISH)}
onEsperanto={this.effectFactory(effectTypes.ESPERANTO)}
onEstonian={this.effectFactory(effectTypes.ESTONIAN)}
onEwe={this.effectFactory(effectTypes.EWE)}
onFaroese={this.effectFactory(effectTypes.FAROESE)}
onFijian={this.effectFactory(effectTypes.FIJIAN)}
onFilipino={this.effectFactory(effectTypes.FILIPINO)}
onFinnish={this.effectFactory(effectTypes.FINNISH)}
onFon={this.effectFactory(effectTypes.FON)}
onFrench={this.effectFactory(effectTypes.FRENCH)}
onFrenchCanada={this.effectFactory(effectTypes.FRENCHCANADA)}
onFrisian={this.effectFactory(effectTypes.FRISIAN)}
onFriulian={this.effectFactory(effectTypes.FRIULIAN)}
onFulani={this.effectFactory(effectTypes.FULANI)}
onGa={this.effectFactory(effectTypes.GA)}
onGalician={this.effectFactory(effectTypes.GALICIAN)}
onGeorgian={this.effectFactory(effectTypes.GEORGIAN)}
onGerman={this.effectFactory(effectTypes.GERMAN)}
onGreek={this.effectFactory(effectTypes.GREEK)}
onGuarani={this.effectFactory(effectTypes.GUARANI)}
onGujarati={this.effectFactory(effectTypes.GUJARATI)}
onHaitianCreole={this.effectFactory(effectTypes.HAITIANCREOLE)}
onHakhaChin={this.effectFactory(effectTypes.HAKHACHIN)}
onHausa={this.effectFactory(effectTypes.HAUSA)}
onHawaiian={this.effectFactory(effectTypes.HAWAIIAN)}
onHebrew={this.effectFactory(effectTypes.HEBREW)}
onHiligaynon={this.effectFactory(effectTypes.HILIGAYNON)}
onHindi={this.effectFactory(effectTypes.HINDI)}
onHmong={this.effectFactory(effectTypes.HMONG)}
onHungarian={this.effectFactory(effectTypes.HUNGARIAN)}
onHunsrik={this.effectFactory(effectTypes.HUNSRIK)}
onIban={this.effectFactory(effectTypes.IBAN)}
onIcelandic={this.effectFactory(effectTypes.ICELANDIC)}
onIgbo={this.effectFactory(effectTypes.IGBO)}
onIlocano={this.effectFactory(effectTypes.ILOCANO)}
onIndonesian={this.effectFactory(effectTypes.INDONESIAN)}
onInuktutLatin={this.effectFactory(effectTypes.INUKTUTLATIN)}
onInuktutSyllabics={this.effectFactory(effectTypes.INUKTUTSYLLABICS)}
onIrish={this.effectFactory(effectTypes.IRISH)}
onItalian={this.effectFactory(effectTypes.ITALIAN)}
onJamaicanPatois={this.effectFactory(effectTypes.JAMAICANPATOIS)}
onJapanese={this.effectFactory(effectTypes.JAPANESE)}
onJavanese={this.effectFactory(effectTypes.JAVANESE)}
onJingpo={this.effectFactory(effectTypes.JINGPO)}
onKalaallisut={this.effectFactory(effectTypes.KALAALLISUT)}
onKannada={this.effectFactory(effectTypes.KANNADA)}
onKanuri={this.effectFactory(effectTypes.KANURI)}
onKapampangan={this.effectFactory(effectTypes.KAPAMPANGAN)}
onKazakh={this.effectFactory(effectTypes.KAZAKH)}
onKhasi={this.effectFactory(effectTypes.KHASI)}
onKhmer={this.effectFactory(effectTypes.KHMER)}
onKiga={this.effectFactory(effectTypes.KIGA)}
onKikongo={this.effectFactory(effectTypes.KIKONGO)}
onKinyarwanda={this.effectFactory(effectTypes.KINYARWANDA)}
onKituba={this.effectFactory(effectTypes.KITUBA)}
onKokborok={this.effectFactory(effectTypes.KOKBOROK)}
onKomi={this.effectFactory(effectTypes.KOMI)}
onKonkani={this.effectFactory(effectTypes.KONKANI)}
onKorean={this.effectFactory(effectTypes.KOREAN)}
onKrio={this.effectFactory(effectTypes.KRIO)}
onKurdishKurmanji={this.effectFactory(effectTypes.KURDISHKURMANJI)}
onKurdishSorani={this.effectFactory(effectTypes.KURDISHORANI)}
onKyrgyz={this.effectFactory(effectTypes.KYRGYZ)}
onLao={this.effectFactory(effectTypes.LAO)}
onLatgalian={this.effectFactory(effectTypes.LATGALIAN)}
onLatin={this.effectFactory(effectTypes.LATIN)}
onLatvian={this.effectFactory(effectTypes.LATVIAN)}
onLigurian={this.effectFactory(effectTypes.LIGURIAN)}
onLimburgish={this.effectFactory(effectTypes.LIMBURGISH)}
onLingala={this.effectFactory(effectTypes.LINGALA)}
onLithuanian={this.effectFactory(effectTypes.LITHUANIAN)}
onLombard={this.effectFactory(effectTypes.LOMBARD)}
onLuganda={this.effectFactory(effectTypes.LUGANDA)}
onLuo={this.effectFactory(effectTypes.LUO)}
onLuxembourgish={this.effectFactory(effectTypes.LUXEMBOURGISH)}
onMacedonian={this.effectFactory(effectTypes.MACEDONIAN)}
onMadurese={this.effectFactory(effectTypes.MADURESE)}
onMaithili={this.effectFactory(effectTypes.MAITHILI)}
onMakassar={this.effectFactory(effectTypes.MAKASSAR)}
onMalagasy={this.effectFactory(effectTypes.MALAGASY)}
onMalay={this.effectFactory(effectTypes.MALAY)}
onMalayJawi={this.effectFactory(effectTypes.MALAYJAWI)}
onMalayalam={this.effectFactory(effectTypes.MALAYALAM)}
onMaltese={this.effectFactory(effectTypes.MALTESE)}
onMam={this.effectFactory(effectTypes.MAM)}
onManx={this.effectFactory(effectTypes.MANX)}
onMaori={this.effectFactory(effectTypes.MAORI)}
onMarathi={this.effectFactory(effectTypes.MARATHI)}
onMarshallese={this.effectFactory(effectTypes.MARSHALLESE)}
onMarwadi={this.effectFactory(effectTypes.MARWADI)}
onMauritianCreole={this.effectFactory(effectTypes.MAURITIANCREOLE)}
onMeadowMari={this.effectFactory(effectTypes.MEADOWMARI)}
onMeiteilonManipuri={this.effectFactory(effectTypes.MEITEILONMANIPURI)}
onMinang={this.effectFactory(effectTypes.MINANG)}
onMizo={this.effectFactory(effectTypes.MIZO)}
onMongolian={this.effectFactory(effectTypes.MONGOLIAN)}
onMyanmarBurmese={this.effectFactory(effectTypes.MYANMARBURMESE)}
onNahuatlEasternHuasteca={this.effectFactory(effectTypes.NAHUATLEASTERNHUASTECA)}
onNdau={this.effectFactory(effectTypes.NDAU)}
onNdebeleSouth={this.effectFactory(effectTypes.NDEBELESOUTH)}
onNepalbhasaNewari={this.effectFactory(effectTypes.NEPALBHASANEWARI)}
onNepali={this.effectFactory(effectTypes.NEPALI)}
onNKo={this.effectFactory(effectTypes.NKO)}
onNorwegian={this.effectFactory(effectTypes.NORWEGIAN)}
onNuer={this.effectFactory(effectTypes.NUER)}
onOccitan={this.effectFactory(effectTypes.OCCITAN)}
onOdiaOriya={this.effectFactory(effectTypes.ODIAORIYA)}
onOromo={this.effectFactory(effectTypes.OROMO)}
onOssetian={this.effectFactory(effectTypes.OSSETIAN)}
onPangasinan={this.effectFactory(effectTypes.PANGASINAN)}
onPapiamento={this.effectFactory(effectTypes.PAPIAMENTO)}
onPashto={this.effectFactory(effectTypes.PASHTO)}
onPersian={this.effectFactory(effectTypes.PERSIAN)}
onPolish={this.effectFactory(effectTypes.POLISH)}
onPortugueseBrazil={this.effectFactory(effectTypes.PORTUGUESEBRAZIL)}
onPortuguesePortugal={this.effectFactory(effectTypes.PORTUGUESEPORTUGAL)}
onPunjabiGurmukhi={this.effectFactory(effectTypes.PUNJABIGURMUKHI)}
onPunjabiShahmukhi={this.effectFactory(effectTypes.PUNJABISHAHMUKHI)}
onQuechua={this.effectFactory(effectTypes.QUECHUA)}
onQeqchi={this.effectFactory(effectTypes.QEQCHI)}
onRomani={this.effectFactory(effectTypes.ROMANI)}
onRomanian={this.effectFactory(effectTypes.ROMANIAN)}
onRundi={this.effectFactory(effectTypes.RUNDI)}
onRussian={this.effectFactory(effectTypes.RUSSIAN)}
onSamiNorth={this.effectFactory(effectTypes.SAMINORTH)}
onSamoan={this.effectFactory(effectTypes.SAMOAN)}
onSango={this.effectFactory(effectTypes.SANGO)}
onSanskrit={this.effectFactory(effectTypes.SANSKRIT)}
onSantaliLatin={this.effectFactory(effectTypes.SANTALILATIN)}
onSantaliOlChiki={this.effectFactory(effectTypes.SANTALIOLCHIKI)}
onScotsGaelic={this.effectFactory(effectTypes.SCOTSGAELIC)}
onSepedi={this.effectFactory(effectTypes.SEPEDI)}
onSerbian={this.effectFactory(effectTypes.SERBIAN)}
onSesotho={this.effectFactory(effectTypes.SESOTHO)}
onSeychelloisCreole={this.effectFactory(effectTypes.SEYCHELLOISCREOLE)}
onShan={this.effectFactory(effectTypes.SHAN)}
onShona={this.effectFactory(effectTypes.SHONA)}
onSicilian={this.effectFactory(effectTypes.SICILIAN)}
onSilesian={this.effectFactory(effectTypes.SILESIAN)}
onSindhi={this.effectFactory(effectTypes.SINDHI)}
onSinhala={this.effectFactory(effectTypes.SINHALA)}
onSlovak={this.effectFactory(effectTypes.SLOVAK)}
onSlovenian={this.effectFactory(effectTypes.SLOVENIAN)}
onSomali={this.effectFactory(effectTypes.SOMALI)}
onSpanish={this.effectFactory(effectTypes.SPANISH)}
onSundanese={this.effectFactory(effectTypes.SUNDANESE)}
onSusu={this.effectFactory(effectTypes.SUSU)}
onSwahili={this.effectFactory(effectTypes.SWAHILI)}
onSwati={this.effectFactory(effectTypes.SWATI)}
onSwedish={this.effectFactory(effectTypes.SWEDISH)}
onTahitian={this.effectFactory(effectTypes.TAHITIAN)}
onTajik={this.effectFactory(effectTypes.TAJIK)}
onTamazight={this.effectFactory(effectTypes.TAMAZIGHT)}
onTamazightTifinagh={this.effectFactory(effectTypes.TAMAZIGHTTIFINAGH)}
onTamil={this.effectFactory(effectTypes.TAMIL)}
onTatar={this.effectFactory(effectTypes.TATAR)}
onTelugu={this.effectFactory(effectTypes.TELUGU)}
onTetum={this.effectFactory(effectTypes.TETUM)}
onThai={this.effectFactory(effectTypes.THAI)}
onTibetan={this.effectFactory(effectTypes.TIBETAN)}
onTigrinya={this.effectFactory(effectTypes.TIGRINYA)}
onTiv={this.effectFactory(effectTypes.TIV)}
onTokPisin={this.effectFactory(effectTypes.TOKPISIN)}
onTongan={this.effectFactory(effectTypes.TONGAN)}
onTshiluba={this.effectFactory(effectTypes.TSHILUBA)}
onTsonga={this.effectFactory(effectTypes.TSONGA)}
onTswana={this.effectFactory(effectTypes.TSWANA)}
onTulu={this.effectFactory(effectTypes.TULU)}
onTumbuka={this.effectFactory(effectTypes.TUMBUKA)}
onTurkish={this.effectFactory(effectTypes.TURKISH)}
onTurkmen={this.effectFactory(effectTypes.TURKMEN)}
onTuvan={this.effectFactory(effectTypes.TUVAN)}
onTwi={this.effectFactory(effectTypes.TWI)}
onUdmurt={this.effectFactory(effectTypes.UDMURT)}
onUkrainian={this.effectFactory(effectTypes.UKRAINIAN)}
onUrdu={this.effectFactory(effectTypes.URDU)}
onUyghur={this.effectFactory(effectTypes.UYGHUR)}
onUzbek={this.effectFactory(effectTypes.UZBEK)}
onVenda={this.effectFactory(effectTypes.VENDA)}
onVenetian={this.effectFactory(effectTypes.VENETIAN)}
onVietnamese={this.effectFactory(effectTypes.VIETNAMESE)}
onWaray={this.effectFactory(effectTypes.WARAY)}
onWelsh={this.effectFactory(effectTypes.WELSH)}
onWolof={this.effectFactory(effectTypes.WOLOF)}
onXhosa={this.effectFactory(effectTypes.XHOSA)}
onYakut={this.effectFactory(effectTypes.YAKUT)}
onYiddish={this.effectFactory(effectTypes.YIDDISH)}
onYoruba={this.effectFactory(effectTypes.YORUBA)}
onYucatecMaya={this.effectFactory(effectTypes.YUCATECMAYA)}
onZapotec={this.effectFactory(effectTypes.ZAPOTEC)}
onZulu={this.effectFactory(effectTypes.ZULU)}
