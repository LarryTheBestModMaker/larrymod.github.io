class CrimeanTatarCyrillicEffect {
    constructor(audioContext, startSeconds, endSeconds, targetLanguage = "Crimean Tatar (Cyrillic)") {
...
export default CrimeanTatarCyrillicEffect;
