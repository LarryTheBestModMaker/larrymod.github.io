class NahuatlEasternHuastecaEffect {
    constructor(audioContext, startSeconds, endSeconds, targetLanguage = "Nahuatl (Eastern Huasteca)") {
...
export default NahuatlEasternHuastecaEffect;
