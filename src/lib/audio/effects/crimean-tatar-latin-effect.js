class CrimeanTatarLatinEffect {
    constructor(audioContext, startSeconds, endSeconds, targetLanguage = "Crimean Tatar (Latin)") {
...
export default CrimeanTatarLatinEffect;
