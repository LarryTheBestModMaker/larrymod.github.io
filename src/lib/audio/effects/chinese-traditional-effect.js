class ChineseTraditionalEffect {
    constructor(audioContext, startSeconds, endSeconds, targetLanguage = "Chinese (Traditional)") {
...
export default ChineseTraditionalEffect;
