class PortuguesePortugalEffect {
    constructor(audioContext, startSeconds, endSeconds, targetLanguage = "Portuguese (Portugal)") {
...
export default PortuguesePortugalEffect;
